...
class SKILL_METRONOME_SWAY_ADVANCE_MotionGenerator(BaseMotionGenerator):
    ...
    def __init__(self, initial_foot_positions_body, leg_names):
        ...
        # Ground clearance safety margin - reverted to Iteration 2 value
        self.ground_clearance_margin = 0.03  # Conservative margin to avoid over-extension
        
        # Base state - intermediate height between Iteration 2 (0.30m) and Iteration 3 (0.42m)
        self.t = 0.0
        self.root_pos = np.array([0.0, 0.0, 0.35])  # Balanced height for clearance without over-extension
    ...
    def update_base_motion(self, phase, dt):
        ...
        # Slightly increased magnitude with phase-advanced profile
        if 0.0 <= phase < 0.25:
            # Right sway - right legs compressing, base should rise
            sway_progress = phase / 0.25
            # Phase-advanced sine to start rising earlier, increased magnitude
    ...
    def compute_foot_position_body_frame(self, leg_name, phase):
        ...
        Ground clearance margin is applied SELECTIVELY only to compressed legs.
        """
        ...
        # Track whether this leg is compressed in current phase
        is_compressed = False
        ...
        # Apply ground clearance safety margin SELECTIVELY
