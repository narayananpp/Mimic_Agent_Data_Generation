...
class SKILL_FRONT_FLIP_MotionGenerator(BaseMotionGenerator):
    ...
    def __init__(self, initial_foot_positions_body, leg_names):
        ...
        # Motion parameters balanced to avoid height violations, joint limits, and ground penetration
        self.crouch_depth = 0.05          # Moderate crouch avoiding deep knee flexion
        ...
        self.landing_extension = 0.05     # Balanced downward extension (reduced from 0.08)
    ...
    def update_base_motion(self, phase, dt):
        ...
        # Phase 0.70-0.85: Landing preparation - reduced descent rate
            ...
            # Extended pitch rate decay for better body alignment at landing
    ...
    def compute_foot_position_body_frame(self, leg_name, phase):
        ...
        Balanced landing extension to avoid both ground penetration and knee overextension.
        """
        ...
        # Phase 0.70-0.85: Landing preparation - extend legs downward (conservative magnitude)
        elif phase < 0.85:
            local_phase = (phase - 0.70) / 0.15
            
            # Release tuck: transition from tucked to neutral position
            ...
            # Add downward extension for landing (reduced to 0.05m to avoid knee overextension)
        ...
        # Phase 0.85-1.00: Landing and stabilization
            ...
            # Compression profile: extend down initially on contact, then release
            # Reduced compression magnitude from 0.05 to 0.03 to avoid cumulative overextension
            if local_phase < 0.5:
                # First half: maintain extension with gentle compression on impact
                compression = 0.03 * np.sin(np.pi * local_phase * 2.0)
                foot[2] -= (self.landing_extension + compression)
            else:
                # Second half: release compression back toward neutral
