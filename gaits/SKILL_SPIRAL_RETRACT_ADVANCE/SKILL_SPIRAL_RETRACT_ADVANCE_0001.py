...
class SKILL_SPIRAL_RETRACT_ADVANCE_MotionGenerator(BaseMotionGenerator):
    ...
    def __init__(self, initial_foot_positions_body, leg_names):
        ...
        self.vertical_velocity_amplitude = 0.15  # Vertical oscillation velocity amplitude (m/s)
        self.pitch_rate_amplitude = 0.15  # Pitch modulation amplitude (rad/s)
    ...
    def compute_foot_position_body_frame(self, leg_name, phase):
        """
        Compute spiral foot trajectory in BODY frame.
        
        Combines two motion components:
