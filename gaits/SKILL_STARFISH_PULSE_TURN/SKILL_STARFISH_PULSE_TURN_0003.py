...
class SKILL_STARFISH_PULSE_TURN_MotionGenerator(BaseMotionGenerator):
    ...
    def compute_foot_position_body_frame(self, leg_name, phase):
        ...
        Feet maintain body-frame Z position (no compensation needed for base height).
        """
        ...
        # Z position: maintain body-frame Z coordinate (feet rise with base when base rises)
