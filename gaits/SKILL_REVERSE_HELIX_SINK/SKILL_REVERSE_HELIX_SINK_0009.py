...
class SKILL_REVERSE_HELIX_SINK_MotionGenerator(BaseMotionGenerator):
    ...
    def __init__(self, initial_foot_positions_body, leg_names):
        ...
        # Use fixed, conservative nominal height that is known safe for quadrupeds
        self.nominal_height = 0.30  # Standard quadruped stance height
        ...
        self.min_height = 0.23  # Only descend 7 cm to avoid joint limits
    ...
    def compute_foot_position_body_frame(self, leg_name, phase):
        ...
        if height_drop > 0.03:  # Start spreading only after 3cm descent
            spread_factor = (height_drop - 0.03) / (self.height_descent_total - 0.03)
