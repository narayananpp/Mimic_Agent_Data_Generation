...
class SKILL_CRAB_DIAGONAL_SCUTTLE_MotionGenerator(BaseMotionGenerator):
    ...
    def __init__(self, initial_foot_positions_body, leg_names):
        ...
        self.stance_height_offset = 0.025  # Ground clearance safety margin
    ...
    def update_base_motion(self, phase, dt):
        ...
        Vertical velocity balanced to prevent cumulative drift.
        """
        vx = 0.0
        vy = 0.0
        vz = 0.0
        ...
        if 0.0 <= phase < 0.3:
            ...
            vz = 0.0  # No downward velocity to prevent drift
