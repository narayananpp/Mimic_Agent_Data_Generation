...
class SKILL_PULSE_SURGE_FORWARD_MotionGenerator(BaseMotionGenerator):
    ...
    def __init__(self, initial_foot_positions_body, leg_names):
        ...
        self.vertical_extension = 0.08  # Feet extend DOWN in world frame during compression (UP in body frame)
        
        # Base velocity parameters - balanced vertical motion
        self.surge_vx_max = 1.5  # Peak forward velocity during surge
        self.surge_vz_up = 0.18  # Moderate upward velocity during surge (reduced from 0.5)
        self.surge_vz_down = -0.18  # Balanced downward velocity during compression (increased from -0.08)
    ...
    def update_base_motion(self, phase, dt):
        ...
        if phase < 0.2:
            ...
            # Downward motion during compression, balanced with surge
        ...
        # Phase 0.2-0.4: Explosive surge
            ...
            # Moderate upward lift during surge
        ...
        # Phase 0.4-0.6: Extended glide
            ...
            # Gentle downward drift to maintain contact and balance cycle
            vz = -0.03 * local_phase
        ...
        # Phase 0.6-0.8: Gather transition
            ...
            # Continued gentle descent
            vz = -0.03 - 0.05 * np.sin(np.pi * local_phase / 2.0)
    ...
    def compute_foot_position_body_frame(self, leg_name, phase):
        ...
        if phase < 0.2:
            ...
            # Vertical: feet extend DOWN in world (UP in body) during compression to maintain contact
            # As base descends, feet appear higher in body frame
        ...
        # Phase 0.4-0.6: Extended glide
            ...
            # Feet reach slightly down in body frame to maintain contact as base stabilizes
            foot[2] = base_pos[2] - 0.02 * local_phase
        ...
        # Phase 0.6-0.8: Gather transition begins
            ...
            # Feet begin extending down in world frame (up in body frame) as base begins descent
            foot[2] = base_pos[2] - 0.02 + (self.vertical_extension + 0.02) * gather_progress
