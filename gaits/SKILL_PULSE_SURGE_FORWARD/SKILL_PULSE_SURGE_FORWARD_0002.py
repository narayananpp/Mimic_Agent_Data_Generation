...
class SKILL_PULSE_SURGE_FORWARD_MotionGenerator(BaseMotionGenerator):
    ...
    def __init__(self, initial_foot_positions_body, leg_names):
        ...
        self.vertical_compression = 0.05  # Vertical compression amount (reduced for safety)
        
        # Base velocity parameters
        self.surge_vx_max = 1.5  # Peak forward velocity during surge
        self.surge_vz_up = 0.5  # Upward velocity during surge (increased for compensation)
        self.surge_vz_down = -0.08  # Downward velocity during compression (greatly reduced)
        ...
        # Vertical position tracking for drift prevention
        self.nominal_height = 0.0
        self.vertical_drift_compensation = 0.0
    ...
    def update_base_motion(self, phase, dt):
        ...
        if phase < 0.2:
            ...
            # Minimal downward motion, smooth transition
        ...
        # Phase 0.2-0.4: Explosive surge
            ...
            # Strong upward lift during surge to compensate for any compression descent
        ...
        # Phase 0.4-0.6: Extended glide
            ...
            # Slight upward drift to maintain height
            vz = 0.05 * (1.0 - local_phase)
        ...
        # Phase 0.6-0.8: Gather transition
            ...
            # Gradual descent with smooth transition
            vz = -0.05 * np.sin(np.pi * local_phase / 2.0)
        ...
        # Phase 0.8-1.0: Reset compression
            ...
            # Gentle downward to complete compression, smooth into cycle restart
            vz = self.surge_vz_down * smoothing
    ...
    def compute_foot_position_body_frame(self, leg_name, phase):
        ...
        if phase < 0.2:
            ...
            # Vertical compression: feet move DOWN relative to body (negative displacement)
        ...
        # Phase 0.2-0.4: Explosive surge extension
            ...
            # Vertical extension: return to nominal height (remove compression)
        ...
        # Phase 0.6-0.8: Gather transition begins
            ...
            # Slight vertical compression begins (downward)
            foot[2] = base_pos[2] - self.vertical_compression * gather_progress
        ...
        # Phase 0.8-1.0: Reset compression (complete gathering)
            ...
            # Complete vertical compression (downward displacement)
            foot[2] = base_pos[2] - self.vertical_compression * gather_progress
