...
class SKILL_CROSSOVER_WAVE_SKATE_MotionGenerator(BaseMotionGenerator):
    ...
    def __init__(self, initial_foot_positions_body, leg_names):
        ...
        self.roll_amplitude = 0.10  # Roll oscillation amplitude (rad) - reduced for safety
    ...
    def compute_foot_position_body_frame(self, leg_name, phase):
        ...
        All wheels maintain continuous ground contact - no vertical modulation
        """
        ...
        # No vertical modulation - wheels maintain continuous ground contact
