...
class SKILL_RISING_SPIRAL_JUMP_MotionGenerator(BaseMotionGenerator):
    ...
    def __init__(self, initial_foot_positions_body, leg_names):
        ...
        # Jump parameters - FINAL TUNING to respect height envelope [0.1, 0.68]
        self.compression_depth = 0.12  # Moderate compression to lower starting point
        self.launch_vz = 0.67  # Reduced from 0.72 to 0.67 to eliminate final 0.020m overshoot
    ...
    def update_base_motion(self, phase, dt):
        ...
        # Aerial spiral extension [0.4, 0.6]: upward velocity decelerating aggressively
            ...
            # Decelerate upward velocity aggressively with increased damping
            vz = self.launch_vz * np.cos(local_phase * np.pi / 2) * (1.0 - local_phase * 0.4)
        ...
        # Peak extension [0.6, 0.8]: transition to downward velocity
            ...
            # Accelerate downward to arrest upward momentum
