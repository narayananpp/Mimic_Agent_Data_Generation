...
class SKILL_PHOENIX_RISE_SPIN_MotionGenerator(BaseMotionGenerator):
    ...
    def __init__(self, initial_foot_positions_body, leg_names):
        ...
        # Motion parameters
        self.crouch_compression = 0.3  # Compression factor for initial crouch (closer to body center)
        self.max_radial_extension = 1.5  # Maximum radial extension factor for wing spread
        self.rise_height = 0.3  # Total vertical rise distance (meters)
