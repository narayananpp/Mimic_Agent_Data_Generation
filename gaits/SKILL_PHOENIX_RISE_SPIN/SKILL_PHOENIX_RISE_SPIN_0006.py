...
class SKILL_PHOENIX_RISE_SPIN_MotionGenerator(BaseMotionGenerator):
    ...
    def __init__(self, initial_foot_positions_body, leg_names):
        ...
        # Motion parameters (reduced based on diagnosis)
    ...
    def compute_foot_position_body_frame(self, leg_name, phase):
        ...
        Foot z-coordinates are slightly adjusted to maintain better ground tracking during rise.
        """
        ...
        # Slight foot z-adjustment to help maintain ground contact during rise
        # As legs extend and base rises, allow feet to track downward slightly
        if phase >= 0.2 and phase <= 0.8:
            rise_progress = (phase - 0.2) / (0.8 - 0.2)
            # Apply small downward offset during rise to ease joint extension requirements
            z_offset = -0.02 * rise_progress
            foot_pos[2] += z_offset
