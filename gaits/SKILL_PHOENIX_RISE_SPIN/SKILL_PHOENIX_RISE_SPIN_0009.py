...
class SKILL_PHOENIX_RISE_SPIN_MotionGenerator(BaseMotionGenerator):
    ...
    def __init__(self, initial_foot_positions_body, leg_names):
        ...
        # Motion parameters - conservative values proven safe in previous iterations
        self.crouch_compression = 0.5  # Moderate compression for stable initial state
        self.max_radial_extension = 1.1  # Conservative extension to ensure reachability
        self.rise_height = 0.20  # Conservative rise to stay well within height envelope
    ...
    def compute_foot_position_body_frame(self, leg_name, phase):
        ...
        Extension completes by phase 0.6, before rotation begins.
        This ensures feet are in stable extended positions when body rotates.
        """
        ...
        # Apply radial extension in x-y plane only
        foot_pos = base_foot.copy()
        foot_pos[0] *= extension_factor
        foot_pos[1] *= extension_factor
        foot_pos[2] = base_foot[2]  # Keep z constant for ground contact
