...
class SKILL_AUGER_DRILL_DESCENT_MotionGenerator(BaseMotionGenerator):
    ...
    def __init__(self, initial_foot_positions_body, leg_names):
        ...
        self.descent_rate = -0.08  # Reduced constant downward velocity for smoother joint motion
        ...
        # Use no radial scaling (1.0x) to stay within kinematic limits
        self.foot_radii = {}
        self.foot_z_offsets = {}
        for leg in leg_names:
            base_pos = self.base_feet_pos_body[leg]
            radius = np.sqrt(base_pos[0]**2 + base_pos[1]**2)
            # No radial scaling - use base positions exactly
            self.foot_radii[leg] = radius
            # Use original z-offset without safety margin
    ...
    def compute_foot_position_body_frame(self, leg_name, phase):
        ...
        # Circular orbit at base radius (no scaling)
