...
class SKILL_AUGER_DRILL_DESCENT_MotionGenerator(BaseMotionGenerator):
    ...
    def __init__(self, initial_foot_positions_body, leg_names):
        ...
        # Use modest 1.05x scaling to maintain workspace margin
        for leg_name in self.leg_names:
            ...
            if radial_xy > 0:
                ...
                foot[0] *= scale_factor
                foot[1] *= scale_factor
            # Trust initial z-positions as valid ground contact configuration
        ...
        # -0.035 m/s provides visible descent while keeping vertical compensation
        # within joint limits over the cycle
        self.descent_rate = -0.035  # negative for downward motion
    ...
    def compute_foot_position_body_frame(self, leg_name, phase):
        ...
        # Small positive margin to ensure contact without penetration
        z_compensation = -self.descent_per_cycle * phase + 0.002
