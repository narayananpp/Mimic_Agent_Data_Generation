...
class SKILL_AUGER_DRILL_DESCENT_MotionGenerator(BaseMotionGenerator):
    ...
    def __init__(self, initial_foot_positions_body, leg_names):
        ...
        self.radial_amplitude = 0.03  # Radial modulation amplitude
    ...
    def compute_foot_position_body_frame(self, leg_name, phase):
        ...
        - Vertical position set to maintain ground contact (world z = 0)
        ...
        # Enforce ground contact: set body-frame z such that world-frame z = 0
        # World frame: foot_world_z = base_z + foot_body_z
        # For ground contact: 0 = base_z + foot_body_z
        # Therefore: foot_body_z = -base_z
        foot[2] = -self.root_pos[2]
