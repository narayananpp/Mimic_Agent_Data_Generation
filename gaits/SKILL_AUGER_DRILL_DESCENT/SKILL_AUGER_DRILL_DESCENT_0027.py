...
class SKILL_AUGER_DRILL_DESCENT_MotionGenerator(BaseMotionGenerator):
    ...
    def __init__(self, initial_foot_positions_body, leg_names):
        ...
        for leg_name in self.leg_names:
            ...
            # Elevate baseline foot z to compensate for extension geometry and ensure ground clearance
            foot[2] += 0.08
        
        # Descent parameters - reduced for safer operation
        self.total_descent = 0.12
    ...
    def compute_foot_position_body_frame(self, leg_name, phase):
        ...
        UPWARD relative to the body frame. We apply generous upward compensation to ensure
        continuous ground contact throughout the entire drilling descent motion.
        """
        foot = self.base_feet_pos_body[leg_name].copy()
        
        # Apply upward z-adjustment to compensate for body descent
        # Includes safety margin beyond just descent compensation
