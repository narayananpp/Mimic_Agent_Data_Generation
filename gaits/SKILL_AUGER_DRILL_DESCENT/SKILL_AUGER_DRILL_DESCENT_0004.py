...
class SKILL_AUGER_DRILL_DESCENT_MotionGenerator(BaseMotionGenerator):
    ...
    def __init__(self, initial_foot_positions_body, leg_names):
        ...
        # Base foot positions (body frame reference) - use XY only for stance configuration
        ...
        # Store initial base height to compute absolute descent
    ...
    def update_base_motion(self, phase, dt):
        ...
        """
        # Capture initial base height on first call
    ...
    def compute_foot_position_body_frame(self, leg_name, phase):
        ...
        - Z: set to maintain world-frame ground contact as base descends
        - Angular offset creates symmetric drill-bit distribution
        """
        # Get base XY position for this leg (natural stance position in body frame)
        ...
        # XY: Add helical offset to natural stance position
        foot_x = base_pos[0] + helix_offset_x
        foot_y = base_pos[1] + helix_offset_y
        
        # Z: Compute body-frame Z to maintain ground contact in world frame
        # With pure yaw rotation and vertical translation, world-frame foot Z is approximately:
        # Z_world = root_pos[2] + foot_z_body
        # To maintain ground contact (Z_world = 0), we need:
        # foot_z_body = -root_pos[2]
        # Add small positive clearance for numerical stability
        ground_clearance = 0.002
        foot_z = -self.root_pos[2] + ground_clearance
