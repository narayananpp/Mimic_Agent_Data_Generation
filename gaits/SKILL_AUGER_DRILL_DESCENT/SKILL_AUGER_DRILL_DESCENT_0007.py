...
class SKILL_AUGER_DRILL_DESCENT_MotionGenerator(BaseMotionGenerator):
    ...
    - Body-frame x,y positions constant (modestly extended radially)
    ...
    def __init__(self, initial_foot_positions_body, leg_names):
        ...
        # Use modest 1.08x scaling to maintain workspace margin for vertical compensation
        for leg_name in self.leg_names:
            ...
            if radial_xy > 0:
                ...
                foot[0] *= scale_factor
                foot[1] *= scale_factor
            # Set initial z-position to mid-workspace negative value
            # This allows compensation range to stay within reachable workspace
            # Assume initial positions are near ground, offset downward by 6cm
            foot[2] = foot[2] - 0.06
        ...
        # Descent rate: reduced to maintain workspace reachability
        # -0.045 m/s provides visible descent while keeping vertical compensation
        # within joint limits over the cycle
        self.descent_rate = -0.045  # negative for downward motion
    ...
    def compute_foot_position_body_frame(self, leg_name, phase):
        ...
        Body-frame x,y positions are constant (modestly extended radially).
        ...
        # Add small negative bias to ensure feet press into ground
        z_compensation = -self.descent_per_cycle * phase - 0.008
