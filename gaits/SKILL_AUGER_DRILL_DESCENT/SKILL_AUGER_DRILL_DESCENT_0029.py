...
class SKILL_AUGER_DRILL_DESCENT_MotionGenerator(BaseMotionGenerator):
    ...
    def __init__(self, initial_foot_positions_body, leg_names):
        ...
        # Moderate radial extension for drill effect while maintaining kinematic safety
        ...
        for leg_name in self.leg_names:
            ...
            # Robust baseline elevation to ensure feet start above ground with margin
            foot[2] += 0.055
    ...
    def compute_foot_position_body_frame(self, leg_name, phase):
        ...
        rate to maintain constant world-frame ground contact, plus a small safety margin.
        """
        ...
        safety_margin = 0.012
        foot[2] += upward_compensation + safety_margin
