...
class SKILL_AUGER_DRILL_DESCENT_MotionGenerator(BaseMotionGenerator):
    ...
    def __init__(self, initial_foot_positions_body, leg_names):
        ...
        # Minimal radial extension for drill effect while maintaining kinematic safety
        self.extension_factor = 1.05
        for leg_name in self.leg_names:
            ...
            # Minimal baseline elevation to compensate for extension geometry only
            foot[2] += 0.02
        
        # Descent parameters - moderate for clear drilling visual
        self.total_descent = 0.15
    ...
    def compute_foot_position_body_frame(self, leg_name, phase):
        ...
        UPWARD relative to the body frame. We apply upward compensation matching the descent
        rate to maintain constant world-frame ground contact.
        """
        foot = self.base_feet_pos_body[leg_name].copy()
        
        # Apply upward z-adjustment to compensate for body descent
        # Matches descent exactly to maintain constant world-frame foot height at ground level
        upward_compensation = self.total_descent * phase
