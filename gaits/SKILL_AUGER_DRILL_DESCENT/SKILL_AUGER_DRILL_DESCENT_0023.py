...
class SKILL_AUGER_DRILL_DESCENT_MotionGenerator(BaseMotionGenerator):
    ...
    def __init__(self, initial_foot_positions_body, leg_names):
        ...
        self.descent_rate = -0.10  # Constant downward velocity (m/s)
        ...
        for leg in leg_names:
            ...
            # Use conservative 1.02x scaling for kinematic safety
            self.foot_radii[leg] = radius * 1.02
            # Use original z-offset with minimal adjustment for ground contact
            # Add only 0.005m (5mm) safety margin to ensure starting at ground level
            self.foot_z_offsets[leg] = base_pos[2] + 0.005
    ...
    def compute_foot_position_body_frame(self, leg_name, phase):
        ...
        # Compensate for base descent in body-frame z-coordinate
