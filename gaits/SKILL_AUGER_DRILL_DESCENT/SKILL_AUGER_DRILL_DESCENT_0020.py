...
class SKILL_AUGER_DRILL_DESCENT_MotionGenerator(BaseMotionGenerator):
    ...
    def __init__(self, initial_foot_positions_body, leg_names):
        ...
        for leg in self.leg_names:
            ...
            # Restored to 17% which was proven stable in iteration 4
        ...
        # Drilling motion parameters - restored to iteration 4 baseline
        self.descent_rate = -0.10  # Proven stable descent rate
    ...
    def compute_foot_position_body_frame(self, leg_name, phase):
        ...
        # Compensation factor of 0.32 represents minimal increment from iteration 4's 0.30
        # (which achieved 96% success with only minor late penetration)
        # This 6.7% increase should eliminate remaining violations while staying well below
        # the 0.36 threshold that caused airborne failure in current iteration
        descent_compensation = -self.descent_rate * self.t * 0.32
