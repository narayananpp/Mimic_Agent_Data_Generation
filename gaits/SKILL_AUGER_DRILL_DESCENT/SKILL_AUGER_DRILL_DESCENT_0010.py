...
class SKILL_AUGER_DRILL_DESCENT_MotionGenerator(BaseMotionGenerator):
    ...
    def __init__(self, initial_foot_positions_body, leg_names):
        ...
        # Height envelope for base descent
        ...
        self.radial_amplitude = 0.03  # Reduced radial modulation to stay within workspace
    ...
    def compute_foot_position_body_frame(self, leg_name, phase):
        ...
        - Vertical position adjusted to compensate for base descent (maintains ground contact)
        ...
        # New radial distance (reduced amplitude to avoid workspace limits)
        ...
        # Adjust vertical position to maintain ground contact as base descends
        # Current base height
        current_base_height = self.root_pos[2]
        
        # To maintain ground contact (world z = 0), foot must be positioned at -base_height in body frame
        # Start from initial body frame z position and adjust based on base descent
        initial_base_height = self.max_height
        base_descent = initial_base_height - current_base_height
        
        # Compensate for base descent: as base goes down, feet move up in body frame to stay grounded
        foot[2] = self.base_feet_pos_body[leg_name][2] + base_descent
