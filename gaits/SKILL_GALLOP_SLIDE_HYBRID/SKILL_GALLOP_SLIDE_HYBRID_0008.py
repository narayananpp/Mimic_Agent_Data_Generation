...
class SKILL_GALLOP_SLIDE_HYBRID_MotionGenerator(BaseMotionGenerator):
    ...
    def __init__(self, initial_foot_positions_body, leg_names):
        ...
        # Base foot positions (BODY frame, neutral stance) with front-leg-specific offset
    ...
    def compute_foot_position_body_frame(self, leg_name, phase):
        """
        Compute foot position in BODY frame with deeper Z offsets for front legs.
        Front legs lift earlier during thrust phase.
        """
        ...
        # Phase 0.15-0.3: Thrust/launch
            ...
            if is_front:
                ...
                # Front legs lift earlier at local_phase > 0.2
                if local_phase > 0.2:
                    flight_local = (local_phase - 0.2) / 0.8
                    foot[2] += self.flight_clearance * np.sin(np.pi * flight_local) - 0.08 * (1.0 - flight_local)
                else:
                    foot[2] -= 0.08
            else:
                if local_phase < 0.7:
                    ...
                    # Simplified flight phase Z trajectory
                    flight_local = (local_phase - 0.65) / 0.35
                    flight_local = np.clip(flight_local, 0.0, 1.0)
                    foot[0] -= 0.08
        ...
        # Phase 0.3-0.6: Slide/glide - extended landing transition
            ...
            if local_phase < 0.40:
                ...
                if is_front:
                    ...
                    foot[2] += flight_z - 0.08 * smooth_land
                else:
