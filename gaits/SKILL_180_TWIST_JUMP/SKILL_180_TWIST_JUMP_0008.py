...
class SKILL_180_TWIST_JUMP_MotionGenerator(BaseMotionGenerator):
    ...
    def __init__(self, initial_foot_positions_body, leg_names):
        ...
        self.landing_extension = 0.055  # Conservative downward extension for landing (m)
    ...
    def compute_foot_position_body_frame(self, leg_name, phase):
        ...
        Landing phase explicitly returns to neutral position for phase continuity.
        """
        ...
        # Phase 0.92-1.0: Landing absorption and return to neutral
        else:
            local_phase = (phase - 0.92) / 0.08
            
            # Transition from extended position back to neutral (base_feet_pos_body)
            # This ensures phase wrap continuity
            # Start with full extension, smoothly reduce to zero by phase 1.0
            extension_remaining = self.landing_extension * (1.0 - local_phase)
