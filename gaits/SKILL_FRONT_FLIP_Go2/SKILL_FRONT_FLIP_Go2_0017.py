...
class SKILL_FRONT_FLIP_Go2_MotionGenerator(BaseMotionGenerator):
    ...
    def __init__(self, initial_foot_positions_body, leg_names):
        ...
        # Launch parameters - balanced for envelope and clearance
        self.launch_vx = 1.2
        self.launch_vz = 1.7
        ...
        # Leg retraction parameters - reduced to respect joint limits
        self.tuck_height = 0.14  # Reduced from 0.16 to avoid joint violations
        self.tuck_longitudinal = 0.06  # Reduced from 0.07
        
        # Pitch compensation - moderated to balance clearance and joint limits
        self.pitch_compensation_max = 0.10  # Reduced from 0.18
    ...
    def compute_foot_position_body_frame(self, leg_name, phase):
        ...
        if phase < 0.1:
            ...
            # Base upward retraction
            foot[2] += self.tuck_height * smooth
            
            # Moderated pitch compensation for front legs
            if is_front:
                ...
                # Apply moderated compensation scaled to pitch angle
            ...
            # Early airborne: maintain compensation
            progress = (phase - 0.25) / (0.35 - 0.25)
            smooth = 0.5 - 0.5 * np.cos(np.pi * progress)
