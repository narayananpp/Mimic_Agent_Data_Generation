...
class SKILL_WINDSHIELD_WIPER_YAW_MotionGenerator(BaseMotionGenerator):
    ...
    def update_base_motion(self, phase, dt):
        ...
        # Set velocity commands (zero translation, yaw rotation only, height adjustment)
        ...
        self.root_pos[2] += height_adjustment
    ...
    def compute_foot_position_body_frame(self, leg_name, phase):
        ...
        yaw_normalized = abs(yaw_offset) / self.target_yaw_displacement
