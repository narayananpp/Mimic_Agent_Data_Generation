...
class SKILL_PENDULUM_ROCK_ADVANCE_MotionGenerator(BaseMotionGenerator):
    ...
    def __init__(self, initial_foot_positions_body, leg_names):
        ...
        self.roll_amplitude = 0.8  # Roll rate amplitude (rad/s)
        self.sweep_distance = 0.12  # Forward sweep distance per leg
        self.ground_clearance = 0.02  # Minimal clearance during sweep
    ...
    def compute_foot_position_body_frame(self, leg_name, phase):
        ...
        All feet remain grounded with minimal clearance during sweep.
        """
