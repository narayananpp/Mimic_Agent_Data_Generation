...
class SKILL_RICOCHET_BOUNCE_DIAGONAL_MotionGenerator(BaseMotionGenerator):
    ...
    Corrected with increased stance clearance to prevent ground penetration.
    """
    ...
    def __init__(self, initial_foot_positions_body, leg_names):
        ...
        self.vertical_velocity_compress = -0.35
        
        # Yaw parameters
        self.yaw_rate_compress = 1.6
        
        # Leg motion parameters - CORRECTED stance_clearance
        self.compression_depth = 0.06
        self.retraction_height = 0.09
        self.extension_distance = 0.06
        self.stance_clearance = 0.12  # INCREASED from 0.06 to provide margin above compression+descent
    ...
    def compute_foot_position_body_frame(self, leg_name, phase):
        ...
        Key: stance_clearance (0.12m) > compression_depth (0.06m) ensures positive margin
        even after base descent during compression phases.
        """
        ...
        if phase < 0.2:
            ...
            if is_left_leg:
                ...
                # At max compression: foot[2] = base + 0.12 - 0.06 = base + 0.06 (positive margin)
        ...
        # Phase 0.8-1.0: Landing prep (FL, RL landing)
            ...
            if is_left_leg:
                ...
                # Gradually approach stance clearance baseline
